...
class SalesDailyReportWizard(models.TransientModel):
    ...
    #     form_data = {
    #         'company_id': self.env.company and self.env.company.id or False,
    ...
    #         'form': form_data
    #     }
    #     report = self.env.ref('hc_daily_sales_report.report_daily_sales').report_action(self, data=data)
    #     # report_content = report._render_qweb_pdf(data=data)[0]
    #     # report_content = report._render_qweb_pdf(data=data, report_ref='hc_daily_sales_report.report_daily_sales')[0]
    #
    #     return report
    #
