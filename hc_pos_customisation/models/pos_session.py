...
class PosSession(models.Model):
    ...
    def _loader_params_product_product(self):
        """Load the is_package_material fields in product.product"""
        result = super()._loader_params_product_product()
        result['search_params']['fields'].append('is_package')
        return result
    ...
    #     return {'search_params': {'domain': [], 'fields': ['name', 'parent_id']}}
        ...
        # result['search_params']['fields'].append('is_package_material')
        # return result
